...
class CfgVehicles
{
	...
	HEADGEAR_HOLDER(H_HelmetB_light_idfsf,"IDF SF Helmet fuck yeah",EdSubcat_Helmets)
	HEADGEAR_HOLDER(H_HelmetSpecB_light_idfsf,"IDF SF Helmet fuck yeah 2",EdSubcat_Helmets)
