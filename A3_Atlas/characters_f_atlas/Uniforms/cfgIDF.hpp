...
class Atlas_U_I_I_GhillieSuit: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_I_GhillieSuit0;
	picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_I_GhillieSuit_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
	hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Uniforms\Data\I_I_Soldier_01_CO.paa"};
	class ItemInfo: UniformItem
...
class Atlas_U_I_I_OfficerUniform: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_I_OfficerUniform0;
	picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_I_OfficerUniform_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_universal_F.p3d";
	hiddenSelections[] = {camo};
...
class Atlas_U_I_I_Wetsuit: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	displayName = $STR_A3_A_CfgWeapons_U_I_I_Wetsuit0;
	picture = "\A3_Atlas\Characters_F_Atlas\Uniforms\Data\UI\icon_U_I_I_Wetsuit_CA.paa";
	model = "\A3\Characters_F\Common\Suitpacks\suitpack_original_F.p3d";
	hiddenSelections[] = {camo};
	hiddenSelectionsTextures[] = {"\A3_Atlas\Characters_F_Atlas\Uniforms\Data\diver_suit_olive_CO.paa"};
	class ItemInfo: UniformItem
	{
		uniformModel = "-";
...
class Atlas_U_I_I_SFUniform_olive: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = Atlas_I_I_CombatFatigues_02_olive_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class Atlas_U_I_I_SFUniform_shortsleeve_olive: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = Atlas_I_I_CombatFatigues_02_RolledUp_olive_F;
		containerClass = Supply40;
		mass = 40;
	};
};
class Atlas_U_I_I_SFUniform_tee_olive: Uniform_Base
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	...
	{
		uniformModel = "-";
		uniformClass = Atlas_I_I_CombatFatigues_02_Tshirt_olive_F;
		containerClass = Supply40;
		mass = 40;
	};
};