class Atlas_B_A_UAV_06_F: UAV_06_base_F
{
	author = "Bran Flakes";
	class SimpleObject
	{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Atlas_B_A_UAV_06_backpack_F};
	};
	hiddenSelectionsTextures[] = {"\A3_Atlas\Air_F_Atlas\UAV_06\Data\I_I_UAV_06_CO.paa"};
};
class Atlas_B_A_UAV_06_medical_F: UAV_06_medical_base_F
{
	author = "Bran Flakes";
	class SimpleObject
	{
	...
	class assembleInfo
	{
		...
		assembleTo = "";
		displayName = "";
		dissasembleTo[] = {Atlas_B_A_UAV_06_medical_backpack_F};
	};
...
class Atlas_B_A_UAV_06_backpack_F: UAV_06_backpack_base_F
{
	author = "Bran Flakes";
	scope = public;
	scopeCurator = public;
	...
	hiddenSelectionsTextures[] =
	{
		"\A3_Atlas\Supplies_F_Atlas\Bags\Data\UAV_backpack_aucamo_CO.paa",
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = Atlas_B_A_UAV_06_F;
	};
};
class Atlas_B_A_UAV_06_medical_backpack_F: UAV_06_medical_backpack_base_F
{
	author = $STR_A3_A_AveryTheKitty;
	scope = public;
	scopeCurator = public;
	...
	class assembleInfo: assembleInfo
	{
		...
		assembleTo = Atlas_B_A_UAV_06_medical_F;
	};
};