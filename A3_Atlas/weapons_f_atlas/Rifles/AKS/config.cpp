...
class CfgWeapons
{
	...
	class arifle_AKS_alt_F: arifle_AKS_F
	{
		...
		{
			"A3_Atlas\weapons_f_atlas\Rifles\AKS\Data\arifle_AK74U_wood_CO.paa",
			"\A3\Weapons_F_Exp\Rifles\AKS\Data\magazine_ak74_co.paa"
		};
		//picture = "\A3_Atlas\Weapons_F_Atlas\Rifles\AKS\Data\UI\icon_arifle_AK74U_wood_F_ca.paa";
	...
	class arifle_AKSM_F: arifle_AKS_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"A3_Atlas\weapons_f_atlas\Rifles\AKS\Data\arifle_AK74U_black_CO.paa",
			"\A3\Weapons_F_Exp\Rifles\AKS\Data\magazine_ak74_co.paa"
		};
		//picture = "\A3_Atlas\Weapons_F_Atlas\Rifles\AKS\Data\UI\icon_arifle_AK74U_black_F_ca.paa";
		class WeaponSlotsInfo: WeaponSlotsInfo
		{
			class CowsSlot
			{
	...
	class arifle_AKSM_alt_F: arifle_AKSM_F
	{
		...
		hiddenSelectionsTextures[]=
		{
			"A3_Atlas\weapons_f_atlas\Rifles\AKS\Data\arifle_AK74U_plum_CO.paa",
			"\A3\Weapons_F_Exp\Rifles\AKS\Data\magazine_ak74_co.paa"
		};
		//picture = "\A3_Atlas\Weapons_F_Atlas\Rifles\AKS\Data\UI\icon_arifle_AK74U_plum_F_ca.paa";
		magazines[]=
		{
			30Rnd_545x39_Mag_F,
