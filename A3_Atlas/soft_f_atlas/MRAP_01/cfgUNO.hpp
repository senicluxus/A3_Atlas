...
class Atlas_I_UNO_MRAP_01_F: MRAP_01_base_F
{
    ...
    //editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_UNO_MRAP_01_F.jpg";
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
...
class Atlas_I_UNO_MRAP_01_gmg_F: MRAP_01_gmg_base_F
{
    ...
    //editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_UNO_MRAP_01_gmg_F.jpg";
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
	faction = Atlas_IND_UNO_F;
...
class Atlas_I_UNO_MRAP_01_hmg_F: MRAP_01_hmg_base_F
{
    ...
    //editorPreview = "\A3_Atlas\EditorPreviews_F_Atlas\Data\CfgVehicles\I_UNO_MRAP_01_hmg_F.jpg";
    scope = public;
    scopeCurator = public;
    side = TGuerrila;
	faction = Atlas_IND_UNO_F;
