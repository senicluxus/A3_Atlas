class Atlas_O_VZ_Truck_02_F: O_Truck_02_covered_F
{
	...
	typicalCargo[] = {Atlas_O_VZ_Soldier_F};
...
class Atlas_O_VZ_Truck_02_box_F: O_Truck_02_box_F
{
	author = $STR_A3_A_AveryTheKitty;
...
class Atlas_O_VZ_Truck_02_medical_F: O_Truck_02_medical_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
...
class Atlas_O_VZ_Truck_02_Ammo_F: O_Truck_02_Ammo_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
...
class Atlas_O_VZ_Truck_02_fuel_F: O_Truck_02_fuel_F
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
	{
...
class Atlas_O_VZ_Truck_02_cargo_F: Truck_02_cargo_base_lxWS
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
		{
...
class Atlas_O_VZ_Truck_02_flatbed_F: Truck_02_flatbed_base_lxWS
{
	author = $STR_A3_A_AveryTheKitty;
	class SimpleObject
		{
